...
public class AutoRedFront extends AutoCommon{
    ...
    public void setUniqueParameters() {
        ...
        STRAFE_TO_BACKBOARD_DISTANCE = 92; //24 inches when starting from the back and 96 inches when starting from front.
        ...
        STRAFE_TO_MIDDLE_TAG_DISTANCE = 20; //constant for both sides
